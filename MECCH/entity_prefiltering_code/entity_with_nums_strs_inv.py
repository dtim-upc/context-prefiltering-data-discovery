...
def process_helpers(df):
    ...
    return train_idx, val_idx, test_idx, test_neg_edges, val_neg_edges
...
if __name__ == "__main__":
    ...
    load_path = Path('/data/nextia_entity_context/raw')
    ...
    data_dict_train = {
        ('ENTITY', 'ENTITY-alignment-ENTITY', 'ENTITY'): (g_train_align_links['src_id'].values, g_train_align_links['dst_id'].values),
        ('ENTITY', '^ENTITY-alignment-ENTITY', 'ENTITY'): (g_train_align_links['dst_id'].values, g_train_align_links['src_id'].values),
    ...
    data_dict_val = {
        ('ENTITY', 'ENTITY-alignment-ENTITY', 'ENTITY'): (g_val_align_links['src_id'].values, g_val_align_links['dst_id'].values),
        ('ENTITY', '^ENTITY-alignment-ENTITY', 'ENTITY'): (g_val_align_links['dst_id'].values, g_val_align_links['src_id'].values),
    ...
    g_train.nodes['ENTITY'].data['x'] = entity_features
    g_train.nodes['STR_ATTR'].data['x'] = str_att_features
    g_train.nodes['NUM_ATTR'].data['x'] = num_att_features

    g_val = dgl.heterograph(data_dict_val, num_nodes_dict, idtype=th.int64)
    g_val.nodes['ENTITY'].data['x'] = entity_features
    g_val.nodes['STR_ATTR'].data['x'] = str_att_features
    g_val.nodes['NUM_ATTR'].data['x'] = num_att_features
    ...
    train_idx, val_idx, test_idx, test_neg_edges, val_neg_edges = process_helpers(helpers)
