...
import dgl.{Commons, Link, NodeClass, NodeNumPost, NodeStrPost}
...
object DGL_post_num_str extends SparkWrapper{
  ...
  def loadLinks(strLinksPath: String, numLinksPath: String, relationshipsPath:String, aligPath: String): (Seq[Link], Seq[Link],  Seq[Link], Seq[Link]) = {
    ...
    (strLinks, numLinks, relLinks, aligLinks)
  ...
  def main(args: Array[String]): Unit = {
    ...
    val (strLinks, numLinks, relLinks, aligLinks) = loadLinks(strLinksPath, numLinksPath,  relLinksPath, alignmentsLinksPath)
